...
import AddaProperty from '../components/RealEstateTable/AddaProperty'
...
const RealEstate = () => {
  ...
  let totalCashflow = (totalRentalIncome - totalMortgagePayment-totalApartmentExpenses).toFixed(2)
  return (
    <div className='padding-tb-lr'>
      ...
      <div className="dashboard-summary">
          {/* <SingleSummary
            ...
            sumName="TOTAL LOAN AMOUNT"
            sumValue="100,000,000"
          />
          <SingleSummary
            sumIcon={(
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          ...
          {/* <SingleSummary
            ...
            sumName="TOTAL PROFITS AFTER MORTGAGE PAYMENT"
            sumValue="4,800,000"
          /> */}
          <SingleSummary
            sumIcon={(
            ...
            sumValue={totalApartmentExpenses}
          />
          <SingleSummary
            sumIcon={(
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
            ...
            sumName="TOTAL CASHFLOW"
            sumValue={totalCashflow}
          />
      </div>
      <div className="table-content">
        <RealEstateTable openPopup={openAddPropertyPopup}/>
      </div>
      ...
      {
        addPropertyOpen && (
          <AddaProperty closePopup={closeAddPropertyPopup} getAllProperties={getAllProperties} />
        )
      }
    </div>
